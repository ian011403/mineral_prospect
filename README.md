...
│                         mineral_prospect and configuration for tools like black
│
...
│
└── mineral_prospect   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes mineral_prospect a Python module
    │
